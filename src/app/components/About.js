...
const About = () => {
  const stats = [
    ...
    { label: "3D Modeling", value: "SketchUp/3D", icon: <FaCube /> },
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute w-[320px] h-[320px] md:w-[450px] md:h-[450px] border-2 border-dashed border-blue-500/30 rounded-full"
            ></motion.div>

            {/* Glowing Backdrop */}
            <div className="absolute inset-0 bg-blue-600/10 blur-[100px] rounded-full -z-10"></div>

            {/* Main Image Container */}
            <motion.div 
              whileHover={{ scale: 1.02 }}
              className="relative w-72 h-72 md:w-[400px] md:h-[400px] rounded-3xl overflow-hidden border-4 border-white dark:border-slate-800 shadow-2xl z-10"
            >
              <Image 
                src="/profile.jpeg"
            ...
            <motion.div 
              ...
              className="absolute -bottom-6 -right-2 md:right-8 bg-blue-600 text-white p-5 rounded-2xl shadow-xl z-20"
            >
              <p className="text-sm font-medium opacity-80 text-center uppercase tracking-tighter leading-tight">Civil</p>
              <p className="text-xl font-bold text-center">Engineer</p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
              Designing the future with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Precision & Engineering</span> Excellence.
            </h2>
            
            <div className="space-y-4 text-slate-600 dark:text-slate-400 text-lg leading-relaxed mb-8">
              <p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-base font-bold leading-none mb-1">{stat.value}</p>
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-10 bg-slate-900 dark:bg-blue-600 text-white px-8 py-4 rounded-2xl font-bold shadow-lg shadow-blue-500/20 transition-all"
            >
              Download Resume
            </motion.button>
          </motion.div>
